"""
Generates complete index.html with AI PC Builder
Run: python generate_index.py
Then update WORKER_URL after deploying Cloudflare Worker
"""
from pathlib import Path

# The HTML is split into parts to avoid Python string length issues
...
.ai-badge::before{content:"✨";font-size:1rem}
...
<button onclick="openPCBuilder()" class="cta-button" style="background:linear-gradient(135deg,#8b5cf6 0%,#6366f1 100%);border:none;cursor:pointer">✨ AI PC Builder</button>
</div>
</div>
<div id="pcBuilderModal" class="modal">
<div class="modal-content">
<button class="modal-close" onclick="closePCBuilder()">×</button>
...
<button class="builder-button" onclick="generateBuild()" id="generateBtn">✨ Generate My Build</button>
</div>
...
def main():
    ...
    print("\n" + "="*60)
    print("IMPORTANT: Update the Cloudflare Worker URL!")
    print("="*60)
    print("\n1. Deploy your Cloudflare Worker (use worker.js artifact)")
    print("2. Get your worker URL")
    print("3. Edit index.html and find this line:")
    print("   const WORKER_URL='https://YOUR-WORKER-NAME...'")
    print("4. Replace with your actual worker URL")
    print("5. Force push to GitHub")
    print("\nThe AI PC Builder will work once URL is updated!")
